 ...
 * @author tomoya
 */
public class dbaccess_kadai7 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            // profilesテーブルのデータを更新
            db_stu = db_con.prepareStatement("update profiles set name = ?, age = ?, birthday = ? where profilesID = ?");
            db_stu.setString(1, "松岡　修造");
            db_stu.setInt(2, 48);
            db_stu.setString(3, "1967-11-06");
            db_stu.setInt(4, 1);
            ...
            // profilesIDが3のデータを取得
            db_st = db_con.prepareStatement("select * from profiles");    //引数として実行したいSQL文を渡す
