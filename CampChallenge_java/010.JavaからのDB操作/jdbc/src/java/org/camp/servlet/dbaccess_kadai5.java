 ...
 * @author tomoya
 */
public class dbaccess_kadai5 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            // 「茂」を含むデータを取得
            db_st = db_con.prepareStatement("select * from profiles where name like ?");    //引数として実行したいSQL文を渡す
            db_st.setString(1, "%茂%");    //「?」への設定
